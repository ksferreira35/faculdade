...
public class LFSR {
	...
	private static boolean rotacionar(boolean[] registrador, boolean tipo) {
		...
		for (int i = 0; i < 31; i++) {
			// Se ele tem 32 bits pq ta indo so para o 31? você so pode ir ate o penultimo.
